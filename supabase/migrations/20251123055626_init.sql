-- Plantícia Initial Schema
-- Core tables for plant management and care tracking
...
------------------------------------------------------------
--  PLANT CARE SCHEDULES (Future use)
------------------------------------------------------------
...
create table public.plant_care_schedules (
  ...
  watering_hour integer default 11, -- hour of day for watering notification (0-23)
  last_watered_at timestamp with time zone, -- last time this care was performed
...
------------------------------------------------------------
--  ARTICLES (Educational content - Future use)
------------------------------------------------------------
